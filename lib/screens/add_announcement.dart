...
import 'package:ssen_company/Repository/firebase/model%20methods/firebase_announcement_methods.dart';
...
class AddAnnouncement extends StatefulWidget {
  ...
  @override
  State<AddAnnouncement> createState() => _AddAnnouncement();
}
...
class _AddAnnouncement extends State<AddAnnouncement> {
  ...
  void AddAnnouncement(CompanyProfileModel company) async {
    ...
    //     .create(company, testimonial, newsImage); //?! no image entry
    UserModel x = UserModel(
        firstName: 'firstName',
        lastName: 'lastName',
        phoneNumber: 'phoneNumber');
    await FirebaseAnnouncementMethods()
        .create(company, announcement, x, newsImage);
