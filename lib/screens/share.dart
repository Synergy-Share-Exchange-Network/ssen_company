                    ...
                    Column(
                      children: [
                        Center(
                         ...
                         SizedBox( // Wrap the Text widget with Expanded
                         width: MediaQuery.of(context).size.width,
                    child: Text(
                      "At TechNex Solutions, we're dedicated to pioneering innovative technological solutions that empower businesses and individuals to thrive in the digital age. Our mission is to revolutionize industries through cutting-edge software development, consulting services, and unparalleled customer support.",
                      style: dark
                ? STextTheme.darkTextTheme.titleSmall
                : STextTheme.lightTextTheme.titleSmall,
                    ),
