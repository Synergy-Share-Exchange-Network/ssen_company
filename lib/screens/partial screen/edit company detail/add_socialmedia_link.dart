...
class AddSocialMediaLink extends StatefulWidget {
  const AddSocialMediaLink({super.key});

  @override
  State<AddSocialMediaLink> createState() => _AddSocialMediaLink();
}

class _AddSocialMediaLink extends State<AddSocialMediaLink> {
  // KeyFigureModel c =KeyFigureModel(name: name, position: position)

  Uint8List? socialImage;
