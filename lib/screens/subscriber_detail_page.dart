...
class SubscriberDetailPage extends StatelessWidget {
  const SubscriberDetailPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    drawer:  MediaQuery.of(context).size.width > phoneSize ?
      ...
      body:MediaQuery.of(context).size.width < phoneSize ? SingleChildScrollView(
        child: Container(
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10), // Adjust spacing between photo and name
              Container(
                child: const Text(
                  "Dawit nigus ",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 27),
